...
const pump_schema_1 = require("./pump.schema");
...
PumpModule = __decorate([
    common_1.Module({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: 'PumpStatus', schema: pump_schema_1.PumpStatusSchema }])
        ],
        controllers: [
            pump_controller_1.PumpController
        ],
        providers: [
